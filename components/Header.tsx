...
import { faBars, faCartShopping, faCross, faPerson, faSearch, faUser, faXmark } from "@fortawesome/free-solid-svg-icons"
...
export default function Header() {
    ...
    return (
        <>
            <div className={`flex w-[90%] max-h-[15vh] p-4 font-base mx-auto items-center justify-between secondary_font_family ${!show ? "custom_underline" : ""}`}>
                <div className="grid items-center gap-2 grid-cols-5 ">
                    ...
                    {show && (
                        <div className={`absolute left-[8%]  p-4 flex flex-col gap-1 lg:hidden md:hidden transition-all duration-300 ease-in-out ${show ? "h-auto top-[12%]" : "h-0 top-[-100%] "}`}>
